...
sections:
  ...
  - block: research-areas
    ...
    content:
      ...
      items:
        - name: ELASTIBD — Liver Fibrosis and Steatosis in IBD
          description: ""
          icon: hero/heart
          status: active
          cta:
        ...
        - name: NLP for Colonoscopy Quality
          description: ""
          ...
          cta:
            text: Talks
            url: /events/
        - name: NLP in Ulcerative Colitis
          description: ""
          icon: hero/code-bracket
          status: active
        - name: National IBD Epidemiology in Türkiye (TÜSEB)
          description: ""
          icon: hero/globe-europe-africa
          status: active
        - name: AI in Crohn's Disease Imaging
          description: ""
          icon: hero/cpu-chip
          status: planning
        - name: Large Language Models for IBD Phenotyping
          description: ""
          icon: hero/sparkles
          status: active
    design:
  ...
  - block: contact-info
    ...
    content:
      title: Contact
      subtitle: "**Open to collaboration** on datasets, multicentre studies, AI/NLP validation and clinical research. Get in touch by e-mail."
      visit_title: Clinic
